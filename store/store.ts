...
import { bookLibraryApi } from "./bookLibrary/bookLibraryApi";
import { studyPlanApi } from "./studyPlan/studyPlanApi";
...
export const store = configureStore({
  reducer: {
    ...
    [bookLibraryApi.reducerPath]: bookLibraryApi.reducer,
